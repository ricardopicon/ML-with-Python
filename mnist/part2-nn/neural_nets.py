...
class NeuralNetwork():
    ...
    def __init__(self):
        ...
        self.input_to_hidden_weights = np.matrix('1. 1.; 1. 1.; 1. 1.') ## W1
        self.hidden_to_output_weights = np.matrix('1. 1. 1.') # W2
        self.biases = np.matrix('0.; 0.; 0.') # b1 & b2
    ...
    def train(self, x1, x2, y):
        ...
        vect_output_layer_activation = np.vectorize(output_layer_activation)
        ...
        activated_output = vect_output_layer_activation(output)# TODO
        ...
        hidden_layer_error = np.multiply(vect_output_layer_activation_derivative(activated_output),self.hidden_to_output_weights.transpose())*output_layer_error # TODO (3 by 1 matrix)

        bias_gradients =  np.multiply(hidden_layer_error, vect_rectified_linear_unit_derivative(hidden_layer_weighted_input)) # TODO
    ...
    def predict(self, x1, x2):
        ...
        hidden_layer_weighted_input = 0# TODO
        hidden_layer_activation = 0# TODO
        output = 0# TODO
        activated_output = 0# TODO
